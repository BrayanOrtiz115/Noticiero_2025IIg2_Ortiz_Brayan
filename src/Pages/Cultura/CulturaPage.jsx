  ...
  useEffect(() => {
    const cargarNoticias = async () => {
      try {
        ...
        console.error('Error cargando noticias de cultura:', error);
      } finally {
        setCargando(false);
      }
    };
  ...
  if (cargando) {
    return (
      <div className="categoria-loading">
        ...
        <p>Cargando noticias de cultura...</p>
      </div>
    );
  }
  ...
  return (
    <div className="categoria-page">
      <div className="categoria-header">
        <div className="categoria-hero cultura-hero">
          <div className="categoria-info">
            <div className="categoria-icon">🎭</div>
            <div>
              <h1>Cultura</h1>
              <p>Arte, música y entretenimiento</p>
            </div>
          </div>
        </div>
      ...
      <div className="categoria-content">
        ...
        {noticiasFiltradas.length === 0 ? (
          <div className="no-noticias">
            ...
            <h3>No hay noticias de cultura</h3>
            <p>
              {busqueda 
                ? 'No se encontraron noticias que coincidan con tu búsqueda.'
                : 'No hay noticias de cultura publicadas aún.'
              }
            </p>
          </div>
        ) : (
              ...
              <article key={noticia.id} className="noticia-card">
                {noticia.imagen && (
                  <div className="noticia-imagen">
                    ...
                    <div className="noticia-categoria">Cultura</div>
                  </div>
                )}
                ...
                <div className="noticia-content">
                  ...
                  <h3 className="noticia-titulo">
                    <Link to={`/cultura/${noticia.id}`}>{noticia.titulo}</Link>
                  </h3>
                  ...
                  <Link to={`/cultura/${noticia.id}`} className="leer-mas">
                    Leer más →
                  </Link>
                </div>
              </article>
